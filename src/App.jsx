...
function MarketIntelPage({ data, loading, onRefresh, onRunHybrid, status, dots, onNewsClick, accent }) {
  ...
  const NewsItem = ({n}) => (
    <div onClick={()=>onNewsClick&&onNewsClick({headline:n.headline,source:n.source,url:n.url})}
      style={{padding:"9px 12px",borderRadius:7,background:"rgba(255,255,255,0.025)",border:"1px solid rgba(255,255,255,0.05)",cursor:"pointer",transition:"background 0.15s"}}
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:20}}>
      ...
      {/* ── MAIN GRID ── */}
      <div className="grid-intel-2col" style={{display:"grid",gap:18,alignItems:"start"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          ...
          {/* HIGH IMPACT */}
          {highNews.length>0&&(
            <div style={{background:"rgba(239,68,68,0.04)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:"1px solid rgba(239,68,68,0.12)",borderTop:"1px solid rgba(239,68,68,0.35)",borderRadius:10,overflow:"hidden"}}>
          ...
          {/* ALL NEWS */}
          <div style={{background:"rgba(16,16,18,0.6)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:"1px solid rgba(255,255,255,0.05)",borderTop:`1px solid rgba(245,158,11,0.3)`,borderRadius:10,overflow:"hidden"}}>
            <div style={{padding:"14px 16px"}}>
              <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:14}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          ...
          {data.cross_asset_signals&&data.cross_asset_signals.length>0&&(
            <div style={{background:"rgba(16,16,18,0.6)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:"1px solid rgba(255,255,255,0.05)",borderTop:"1px solid rgba(99,102,241,0.35)",borderRadius:10,overflow:"hidden"}}>
              <div style={{padding:"14px 16px"}}>
                <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:14}}>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:8}}>
                  {data.cross_asset_signals.map((s,i)=>(
                    <div key={i} style={{padding:"8px 11px",borderRadius:7,background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.05)"}}>
          ...
          {data.risk_radar&&(()=>{
            ...
            return (
              <div style={{background:"rgba(16,16,18,0.6)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:"1px solid rgba(255,255,255,0.05)",borderTop:`1px solid ${rc}55`,borderRadius:10,overflow:"hidden"}}>
                <div style={{padding:"14px 16px"}}>
                  <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:14}}>
          ...
          {data.yield_analysis?.implication&&(
            <div style={{background:"rgba(16,16,18,0.6)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:"1px solid rgba(255,255,255,0.05)",borderTop:`1px solid ${acc}44`,borderRadius:10,overflow:"hidden"}}>
              <div style={{padding:"14px 16px"}}>
          ...
          {/* Macro context */}
          <div style={{background:"rgba(16,16,18,0.6)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:"1px solid rgba(255,255,255,0.05)",borderTop:`1px solid ${yieldColors[data.macro_regime]||acc}55`,borderRadius:10,overflow:"hidden"}}>
            <div style={{padding:"14px 16px"}}>
              <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:12}}>
          ...
          <>
                  ...
                  <div style={{display:"flex",gap:20,alignItems:"stretch",flexWrap:"wrap"}}>
                    ...
                    {aResult.yield_regime&&(
                      <div style={{display:"flex",flexDirection:"column",gap:5}}>
                        <span style={{fontSize:8,color:"#4b5563",letterSpacing:"0.12em"}}>YIELD REGIME</span>
                    ...
                    {aResult.session&&(
                      <div style={{display:"flex",flexDirection:"column",gap:5}}>
                        <span style={{fontSize:8,color:"#4b5563",letterSpacing:"0.12em"}}>SESSIE</span>
                    ...
                    {[
                      ...
                      <div key={l} style={{display:"flex",flexDirection:"column",gap:5}}>
                        <span style={{fontSize:8,color:"#4b5563",letterSpacing:"0.12em"}}>{l}</span>
            ...
            {aResult&&<div style={{marginBottom:14}}>
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                <div style={{display:"flex",alignItems:"center",gap:8}}>
                  <span style={{fontSize:9,fontWeight:700,color:"#4b5563",letterSpacing:"0.16em",fontFamily:"'JetBrains Mono',monospace"}}>SESSIE BREAKDOWN</span>
              ...
              {psStatus==="loading"&&(
                <div style={{background:"#0d0e11",border:`1px solid ${accent}18`,borderRadius:10,padding:"20px 22px",display:"flex",alignItems:"center",gap:10}}>
                  ...
                  <span style={{fontSize:11,color:"#6b7280"}}>Sessie context ophalen...</span>
                </div>
              )}
                  ...
                  <div style={{background:"#0d0e11",border:`1px solid ${accent}15`,borderRadius:10,overflow:"hidden"}}>
                    ...
                    <div style={{padding:"18px 20px",display:"grid",gridTemplateColumns:"auto 1fr auto",gap:20,alignItems:"start"}}>
                      ...
                      <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,minWidth:72,paddingRight:20,borderRight:"1px solid rgba(255,255,255,0.05)"}}>
                        ...
                        {presession.mood_score&&<div style={{fontSize:9,color:"#4b5563",fontFamily:"'JetBrains Mono',monospace"}}>{presession.mood_score}%</div>}
                        {/* Mood bar */}
                      ...
                      <div style={{display:"flex",flexDirection:"column",gap:10}}>
                        ...
                        <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
                          ...
                          {presession.session_time&&<span style={{fontSize:9,color:"#4b5563",fontFamily:"'JetBrains Mono',monospace"}}>{presession.session_time}</span>}
                        ...
                        {presession.mood_explanation&&(
                          <div style={{fontSize:11,color:"#6b7280",lineHeight:1.55,fontStyle:"italic",borderLeft:`2px solid ${mc}33`,paddingLeft:10}}>
                            {presession.mood_explanation}
                          </div>
                        )}
                      </div>
                      ...
                      {presession.key_events_today?.length>0&&(
                        <div style={{display:"flex",flexDirection:"column",gap:5,minWidth:140,paddingLeft:20,borderLeft:"1px solid rgba(255,255,255,0.05)"}}>
                          <div style={{fontSize:8,fontWeight:700,color:"#4b5563",letterSpacing:"0.14em",marginBottom:2,fontFamily:"'JetBrains Mono',monospace"}}>KEY EVENTS</div>
